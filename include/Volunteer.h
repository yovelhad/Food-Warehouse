...
enum class VolunteerType{
    VOLUNTEER, COLLECTOR, LIMITEDCOLLECTOR, DRIVER, LIMITEDDRIVER
};
...
class Volunteer {
    public:
        ...
        //added methods
        string volunteerToString(VolunteerType type) const;
        virtual VolunteerType getType() const = 0;
    ...
    private:
        const int id;
        const string name;
        const VolunteerType type; // The type of the volunteer
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        VolunteerType getType() const override;
    ...
    private:
        ...
        VolunteerType type; // The type of the volunteer
